...
import net.dekuffet.omegacraft.procedures.AdminRingKeybindOnKeyPressedProcedure;
...
public class AdminMenuKeybindMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			AdminRingKeybindOnKeyPressedProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmegacraftMod.addNetworkMessage(AdminMenuKeybindMessage.class, AdminMenuKeybindMessage::buffer, AdminMenuKeybindMessage::new, AdminMenuKeybindMessage::handler);
	}
}
